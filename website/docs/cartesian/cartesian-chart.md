...
|   **`lineColor`**   | <pre>string &#124; {<br /> grid: string;<br /> frame: string;<br />} &#124; {<br /> x: string;<br /> y: string; <br /> frame: string;<br />}</pre>                           | Defines the color of the grid and axis lines. It can either apply to both or be customized to each. It will default to `black` if none is provided.                                                                                                                                                                                |
|   **`lineWidth`**   | <pre>number &#124; {<br /> grid: number;<br /> frame: number;<br />} &#124; {<br /> x: number;<br /> y: number; <br /> frame: number;<br />}</pre>                           | Defines the width of the grid and axis lines. It can either apply to both or be customized to each. It will default to `Stylesheet.hairlineWidth` if none is provided.                                                                                                                                                             |
