...
|   **`title.text`**    | <pre>string</pre>                                | The text content of the axis title.                                                                                                                                                                                                                                                                                                                                                                                            |
| **`title.position`**  | <pre>"left" &#124; "center" &#124; "right"</pre> | The position of the title along the X-axis. Defaults to "center".                                                                                                                                                                                                                                                                                                                                                              |
|  **`title.YOffset`**  | <pre>number</pre>                                | Optional offset for the title along the Y-axis. Defaults to 8.                                                                                                                                                                                                                                                                                                                                                                 |
|   **`title.font`**    | <pre>SkFont &#124; null</pre>                    | Font used for the title text. If null, the default font of the axis is used.                                                                                                                                                                                                                                                                                                                                                   |
...
|  **`enableRescaling`**  | <pre>boolean</pre>                               | When `true`, allows the axis ticks to be rescaled during pan/zoom transformations. When `false`, the ticks will remain fixed at their initial values regardless of zoom level. Defaults to `false`.                                                                                                                                                                                                                              |
|    **`title.text`**     | <pre>string</pre>                                | The text content of the axis title.                                                                                                                                                                                                                                                                                                                                                                                              |
|  **`title.position`**   | <pre>"top" &#124; "center" &#124; "bottom"</pre> | The position of the title along the Y-axis. Defaults to "center".                                                                                                                                                                                                                                                                                                                                                                |
|   **`title.xOffset`**   | <pre>number</pre>                                | Optional offset for the title along the X-axis. Defaults to 2.                                                                                                                                                                                                                                                                                                                                                                   |
|    **`title.font`**     | <pre>SkFont &#124; null</pre>                    | Font used for the title text. If null, the default font of the axis is used.                                                                                                                                                                                                                                                                                                                                                     |
