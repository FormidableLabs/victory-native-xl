...
The initial horizontal bar support is for single-series `HorizontalBar` charts. Grouped and stacked horizontal bars are not part of this component yet; use `BarGroup` and `StackedBar` for vertical grouped and stacked charts.
