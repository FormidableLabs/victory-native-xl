...
const transformInputData = ({
  ...
  const data = [..._data];
  const tickValues =
    axisOptions === null || axisOptions === void 0
      ? void 0
      : axisOptions.tickValues;
  const tickCount =
    (_a =
      axisOptions === null || axisOptions === void 0
        ? void 0
        : axisOptions.tickCount) !== null && _a !== void 0
      ? _a
      : tickHelpers_1.DEFAULT_TICK_COUNT;
  const xTickValues =
  ...
  const yTickValues =
    tickValues && typeof tickValues === "object" && "y" in tickValues
      ? tickValues.y
      : tickValues;
  //todo: percolate y tick labels from here as x tick labels have been
  const xTickLabels =
    tickLabels && typeof tickLabels === "object" && "x" in tickLabels
      ? tickLabels.x
      : tickLabels;
  ...
  const isNumericalData = data.every(
    (datum) => typeof datum[xKey] === "number",
  );
  if (isNumericalData) {
  ...
  const yMin =
    (_d =
      (_c =
        (_b = domain === null || domain === void 0 ? void 0 : domain.y) ===
          null || _b === void 0
          ? void 0
          : _b[0]) !== null && _c !== void 0
        ? _c
        : tickDomainsY === null || tickDomainsY === void 0
          ? void 0
          : tickDomainsY[0]) !== null && _d !== void 0
      ? _d
      : Math.min(
          ...yKeys.map((key) => {
  ...
  const yMax =
    (_g =
      (_f =
        (_e = domain === null || domain === void 0 ? void 0 : domain.y) ===
          null || _e === void 0
          ? void 0
          : _e[1]) !== null && _f !== void 0
        ? _f
    ...
    (_k =
      (_j =
        (_h =
          axisOptions === null || axisOptions === void 0
            ? void 0
            : axisOptions.font) === null || _h === void 0
          ? void 0
          : _h.getSize) === null || _j === void 0
        ? void 0
        : _j.call(_h)) !== null && _k !== void 0
      ? _k
      : 0;
  ...
  const yScaleRange = (() => {
    ...
    const xTickCount =
      (_b =
        typeof (axisOptions === null || axisOptions === void 0
          ? void 0
          : axisOptions.tickCount) === "number"
          ? axisOptions === null || axisOptions === void 0
            ? void 0
    ...
    const yLabelPosition =
      typeof (axisOptions === null || axisOptions === void 0
        ? void 0
        : axisOptions.labelPosition) === "string"
        ? axisOptions.labelPosition
        : (_c =
              axisOptions === null || axisOptions === void 0
                ? void 0
                : axisOptions.labelPosition) === null || _c === void 0
          ? void 0
          : _c.x;
    const xAxisSide =
      (_d =
        axisOptions === null || axisOptions === void 0
          ? void 0
          : axisOptions.axisSide) === null || _d === void 0
        ? void 0
        : _d.x;
    const yLabelOffset =
      (_f =
        typeof (axisOptions === null || axisOptions === void 0
          ? void 0
          : axisOptions.labelOffset) === "number"
          ? axisOptions.labelOffset
          : (_e =
                axisOptions === null || axisOptions === void 0
                  ? void 0
                  : axisOptions.labelOffset) === null || _e === void 0
            ? void 0
            : _e.y) !== null && _f !== void 0
        ? _f
        : 0;
  ...
  const yScale = (0, makeScale_1.makeScale)({
    ...
    padEnd:
      typeof domainPadding === "number"
        ? domainPadding
        : domainPadding === null || domainPadding === void 0
          ? void 0
  ...
  yKeys.forEach((yKey) => {
    ...
    y[yKey].o = data.map((datum) =>
      typeof datum[yKey] === "number" ? yScale(datum[yKey]) : datum[yKey],
    );
  });
      ...
      return (_d =
        (_b =
          (_a =
            axisOptions === null || axisOptions === void 0
              ? void 0
              : axisOptions.font) === null || _a === void 0
            ? void 0
            : _a.getGlyphWidths) === null || _b === void 0
          ? void 0
          : _b
              .call(
                _a,
                axisOptions.font.getGlyphIDs(
                  ((_c =
                    axisOptions === null || axisOptions === void 0
                      ? void 0
                      : axisOptions.formatYLabel) === null || _c === void 0
                    ? void 0
                    : _c.call(axisOptions, yTick)) || String(yTick),
                ),
              )
              .reduce((sum, value) => sum + value, 0)) !== null && _d !== void 0
        ? _d
        : 0;
    }),
  );
  ...
  // Else if, tickValues are provided, we use that instead
  // Else, we find min / max of y values across all yKeys, and use that for y range instead.
  const ixMin = (0, asNumber_1.asNumber)(
      (_o =
        (_m =
          (_l = domain === null || domain === void 0 ? void 0 : domain.x) ===
            null || _l === void 0
            ? void 0
            : _l[0]) !== null && _m !== void 0
          ? _m
          : tickDomainsX === null || tickDomainsX === void 0
            ? void 0
            : tickDomainsX[0]) !== null && _o !== void 0
        ? _o
        : ixNum.at(0),
    ),
    ixMax = (0, asNumber_1.asNumber)(
      (_r =
        (_q =
          (_p = domain === null || domain === void 0 ? void 0 : domain.x) ===
            null || _p === void 0
            ? void 0
            : _p[1]) !== null && _q !== void 0
          ? _q
