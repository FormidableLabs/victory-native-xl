...
const CartesianTransformContext = createContext<CartesianTransformContext | undefined>(undefined)

type CartesianTransformProviderProps = PropsWithChildren<{
  transformState?: ChartTransformState
}>
export const CartesianTransformProvider = ({ transformState, children }: CartesianTransformProviderProps) => {
  ...
  return <CartesianTransformContext.Provider value={{ ...transform }}>{children}</CartesianTransformContext.Provider>
}
